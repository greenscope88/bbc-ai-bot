...
$condition = $hybridBuilder->parse('大阪近期', ['merge_legacy_keyword' => true, 'reference_date' => $ref]);
...
unified_assert(strpos($longByPlatform['tourcenter'], 'dayitourcenter.com.tw') !== false, 'tourcenter long url unchanged');

unified_assert(strpos($context, 'dayitravel.grp.com.tw') === false, 'context no grp long host');
unified_assert(strpos($context, 'dayitourcenter.com.tw') === false, 'context no tourcenter long host');
...
unified_assert(strpos($lineReply, 'dayitourcenter.com.tw') === false, 'LINE no tourcenter long host');
