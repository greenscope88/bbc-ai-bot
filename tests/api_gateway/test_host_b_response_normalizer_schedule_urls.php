...
t(strpos($fb, '🗓️ 行程表：') !== false, '11: fallback has 行程表');
t(strpos($fb, '🚩 釜山測試') !== false, '11b: fallback title with flag');
...
t(strpos($fb, '🔎 更多') !== false && strpos($fb, '行程 & 出團日：') !== false, '11g: fallback search footer label');
