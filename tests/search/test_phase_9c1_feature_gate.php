...
Phase9C1FeatureGate::setRegistryOverrideForTesting(new ConfigTenantRegistry());
...
test_assert(($caseC['reason'] ?? '') === 'tenant_activation_disabled', 'caseC: activation disabled reason');
